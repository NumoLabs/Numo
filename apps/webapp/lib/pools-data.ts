...
export const poolsData: Pool[] = [
  ...
  },
  {
    id: "vesu-btc-vault",
    name: "Vesu BTC Vault",
    description: "Rebalancing BTC vault on Vesu Finance with optimized strategies",
    apy: "4.5%",
    tvl: "$5.2M",
    protocol: "Vesu",
    risk: "Low",
    tokens: ["BTC"],
    url: "https://vesu.xyz",
    details: "Rebalancing vault that optimizes BTC performance through different Vesu Finance strategies.",
    risks: ["Smart contract risk", "Rebalancing strategy risk", "Dependency on Vesu platform"],
    benefits: ["Rebalancing strategy management", "Continuous yield optimization", "Lower risk than liquidity pools"],
  },
  {
    id: "ekubo-btc-usdt",
    name: "Ekubo BTC/USDT",
