// VesuRebalance Contract ABI (V2)
// Updated with new deployment address: 0x06852252Dc7884612bC61409C535c5EC1Dfa1F29c73264481D2ee81b8D5415a5
// Refactored to V2: constructor only accepts oracle (not vesuStruct)
// pool_id is now ContractAddress (not felt252)

export const VESU_REBALANCE_ABI = [
  {
    "type": "impl",
    "name": "ExternalImpl",
    "interface_name": "numo_contracts::strategies::vesu_rebalance::interface::IVesuRebal"
  },
  {
    "type": "enum",
  ...
  {
    "type": "interface",
    "name": "numo_contracts::strategies::vesu_rebalance::interface::IVesuRebal",
    "items": [
      {
        "type": "function",
        "name": "rebalance",
  ...
  {
    "type": "impl",
    "name": "VesuMigrateImpl",
    "interface_name": "numo_contracts::strategies::vesu_rebalance::interface::IVesuMigrate"
  },
  {
    "type": "interface",
    "name": "numo_contracts::strategies::vesu_rebalance::interface::IVesuMigrate",
    "items": [
      {
        "type": "function",
        "name": "vesu_migrate",
  ...
  {
    "type": "event",
    "name": "numo_contracts::strategies::vesu_rebalance::vesu_rebalance::VesuRebalance::Rebalance",
    "kind": "struct",
    "members": [
      {
        "name": "yield_before",
  ...
  {
    "type": "event",
    "name": "numo_contracts::strategies::vesu_rebalance::vesu_rebalance::VesuRebalance::CollectFees",
    "kind": "struct",
    "members": [
      {
        "name": "fee_collected",
  ...
  {
    "type": "event",
    "name": "numo_contracts::strategies::vesu_rebalance::vesu_rebalance::VesuRebalance::Event",
    "kind": "enum",
    "variants": [
      {
      ...
      {
        "name": "Rebalance",
        "type": "numo_contracts::strategies::vesu_rebalance::vesu_rebalance::VesuRebalance::Rebalance",
        "kind": "nested"
      },
      {
        "name": "CollectFees",
        "type": "numo_contracts::strategies::vesu_rebalance::vesu_rebalance::VesuRebalance::CollectFees",
        "kind": "nested"
      },
      {
        "name": "Harvest",
