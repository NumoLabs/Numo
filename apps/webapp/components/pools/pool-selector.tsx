        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-2">
            ...
            <Select value={selectedPool} onValueChange={setSelectedPool}>
              ...
              <SelectContent>
                <SelectItem value="ekubo-btc-usdc">Ekubo BTC/USDC</SelectItem>
                <SelectItem value="ekubo-btc-eth">Ekubo BTC/ETH</SelectItem>
                <SelectItem value="ekubo-btc-usdt">Ekubo BTC/USDT</SelectItem>
                <SelectItem value="ekubo-btc-dai">Ekubo BTC/DAI</SelectItem>
                <SelectItem value="vesu-btc-lending">Vesu BTC Lending</SelectItem>
                <SelectItem value="vesu-btc-vault">Vesu BTC Vault</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="space-y-2">
